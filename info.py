...
PICS = (environ.get('PICS', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB61VvHaGt58tJb1EhOV0Y28SMSPw7Z8zJiCQM5uls_Z-dSvj4Yl6CaRu7&s=10')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB61VvHaGt58tJb1EhOV0Y28SMSPw7Z8zJiCQM5uls_Z-dSvj4Yl6CaRu7&s=10")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002069904994').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002069904994') #Channel / Group Id for force sub ( make sure bot is admin )
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Tamil_Mini') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @Tamil_Mini')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002037384930')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/tmv_admin_bot') #Support group link ( make sure bot is admin )
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'wily-devonna-instant-53a186cc.koyeb.app'))
