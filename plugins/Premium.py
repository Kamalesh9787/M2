...
async def plan(client, message):
    ...
    btn = [
        [InlineKeyboardButton("📲 Send payment screenshot here", user_id=int(5983189506))],
        [InlineKeyboardButton("❌ Close ❌", callback_data="close_data")]
    ]
    await message.reply_photo(photo="https://envs.sh/pAz.jpg", caption=script.PREMIUM_TEXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(btn))
